# lesson to create boilerplate for next lesson. Explain dependancy between classes and how that affects testing
...
# actor = Actor.new('Charles Bronson')
# movie = Movie.new(actor)

# movie.start_shooting

#In order to test the classes, we create a double.
...
RSpec.describe Movie do
    ...
    describe 'start shooting method' do
        it 'expects an actor to do 3 actions' do
            ...
            # expect(stuntman).to receive(:light_on_fire).at_most(1).times  .at_least(1).times  .twice
